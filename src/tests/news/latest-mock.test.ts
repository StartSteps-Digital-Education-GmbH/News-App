...
describe("news controller", () => {
  ...
  describe("default parameters", () => {
    it("should have default query limit parameters", async () => {
      ...
      expect(mockFetchFromNewsAPI).toHaveBeenCalledWith('/everything', expect.objectContaining({ limit: defaultLimit }));
    });
    ...
    it("should have default sortBy parameters", async () => {
      ...
      expect(mockFetchFromNewsAPI).toHaveBeenCalledTimes(1);
      expect(mockFetchFromNewsAPI).toHaveBeenCalledWith('/everything', expect.objectContaining({sortBy: defaultSortBy}));
    })
  });
  ...
  describe("query parameters", () => {
    it("should have correct limit parameter", async () => {
      ...
      expect(mockFetchFromNewsAPI).toHaveBeenCalledTimes(1);
      expect(mockFetchFromNewsAPI).toHaveBeenCalledWith('/everything', expect.objectContaining({ limit: 11 }));
    });
    ...
    it("should have correct sortBy parameter", async () => {
      ...
      expect(mockFetchFromNewsAPI).toHaveBeenCalledTimes(1);
      expect(mockFetchFromNewsAPI).toHaveBeenCalledWith('/everything', expect.objectContaining({ sortBy: "popularity" }));
    })
    ...
    it("should have correct q parameter", async () => {
      ...
      expect(mockFetchFromNewsAPI).toHaveBeenCalledTimes(1);
      expect(mockFetchFromNewsAPI).toHaveBeenCalledWith('/everything', expect.objectContaining({ q: "police" }));
    });
  });
  ...
  describe("invalid parameters", () => {
    describe("limit", () => {
      it("should fail with higher limit", async () => {
        ...
        expect(res.body).toEqual({error: '"limit" must be less than or equal to 100'});
      });
      ...
      it("should fail with lower limit", async () => {
        ...
        expect(mockFetchFromNewsAPI).not.toHaveBeenCalled();
        expect(res.status).toBe(400);
        expect(res.body).toEqual({error: '"limit" must be greater than or equal to 1'});
      });
    ...
    describe("sortBy", () => {
      it("should fail invalid option", async () => {
        ...
        expect(mockFetchFromNewsAPI).not.toHaveBeenCalled();
        expect(res.status).toBe(400);
        expect(res.body).toEqual({error: '"sortBy" must be one of [relevancy, popularity, publishedAt]'});
      });
    });
  });
});